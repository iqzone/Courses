...
<html>
    ...
    <body>
        ...
        <div id="wrapper" class="clearfix">
            ...
            <div id="header">
                <div class="container">
                    <h1 id="title"><a href="<?php echo Yii::app()->homeUrl ?>"><?php echo CHtml::encode($this->pageTitle) ?></a></h1>
            ...
            <div id="nav" class="clearfix">
                <div class="container">
                    ...
                    $this->widget('CMenuTheme', array(
                        'items' => array(
                            array('label' => Yii::t('global', 'homepage'), 'url' => Yii::app()->homeUrl),
            ...
            <div class="content-footer">
                <div class="logo"><div class="image"><a href="<?php echo Yii::app()->homeUrl ?>"></a></div></div>
            </div><!-- /content-footer -->
            <div id="footer">
